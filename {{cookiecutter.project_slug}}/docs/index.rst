...
<https://github.com/darosio/{{ cookiecutter.project_slug }}/blob/main/README.md>`_ file, which provides
...
<https://github.com/darosio/{{ cookiecutter.project_slug }}/blob/main/CHANGELOG.md>`_ file here.
...
- Our GitHub repository: `https://github.com/darosio/{{ cookiecutter.project_slug }}
  <https://github.com/darosio/{{ cookiecutter.project_slug }}>`_
